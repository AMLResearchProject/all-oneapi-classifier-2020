...
#
# Title:         Helper Class
# Description:   Helper class for the OneAPI OpenVINO UP2 Acute Lymphoblastic
#                Leukemia Classifier.
# License:       MIT License
...
class Helpers():
	...
	Helper functions for the OneAPI OpenVINO UP2 Acute Lymphoblastic Leukemia Classifier.
	"""
