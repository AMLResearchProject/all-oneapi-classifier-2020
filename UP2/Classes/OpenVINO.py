...
# Description:   OpenVINO class for the OneAPI OpenVINO UP2 Acute Lymphoblastic
#                Leukemia Classifier.
# License:       MIT License
...
class OpenVINO():
	...
	OpenVINO functions for the OneAPI OpenVINO UP2 Acute Lymphoblastic Leukemia Classifier.
	"""
